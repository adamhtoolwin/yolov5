...
def run(
    ...
    resume=False,  # skip images that already have a saved label file
):
...
def parse_opt():
    ...
    parser.add_argument("--resume", action="store_true", help="skip images that already have a saved label file")
